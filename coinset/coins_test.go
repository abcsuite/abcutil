...
func NewCoin(index int64, value abcutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	// should be two outpoints, with 1st one having 1.29994545ABC value.
	...
	testSimpleCoinTxValue0            = abcutil.Amount(129994545)
	...
	testSimpleCoinTx, _               = abcutil.NewTxFromBytes(testSimpleCoinTxBytes)
