...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/abcsuite/abcutil/coinset)

Package coinset provides Aero-specific convenience functions for selecting
...
```bash
$ go get -u github.com/abcsuite/abcutil/coinset
```
...
The typical use case for this library is for creating raw Aero transactions
