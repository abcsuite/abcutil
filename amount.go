...
// units, "1eN ABC" is returned, where N is the AmountUnit.
...
//
// NewAmount is for specifically for converting ABC to Atoms (atomic units).
...
// See GoDoc for example: http://godoc.org/github.com/abcsuite/abcutil#example-Amount
...
// useful for services that build on top of Aero (for example, calculating
